...
ALLOY_LOKI_TAIL_URL = os.environ.get(
    "ALLOY_LOKI_TAIL_URL",
    "ws://127.0.0.1:12345/loki/api/v1/tail",
)
...
def _build_loki_tail_url(selector: str, limit: Optional[str], start: Optional[str], delay_for: Optional[str]) -> str:
    ...
    return f"{ALLOY_LOKI_TAIL_URL}{separator}{urllib.parse.urlencode(params)}"
